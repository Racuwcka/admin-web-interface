...
final class Migration_3 extends MigrationAbstract implements MigrationInterface
{
    ...
    public function up(): bool
    {
        ...
        return $this->runExecute(
            ...
            requests: [
                new SqlRequest(
                    query: "ALTER TABLE $dataBaseName.$table ADD `test` INT(11) NOT NULL AFTER `descript`;",
                    args: []
                )
            ]
        );
